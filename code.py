...
тестится:
  идея для новой фичи -> гуглишь как это сделать(если не можешь нагуглить спрашиваешь у чатика как сделать, он дает варики и ты уже по ним гуглишь) -> делаешь фичу
