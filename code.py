{
  ...
  (юзай ии как генератор плохого кода по твоей декомпозиции(чтобы сэкономить время)(быстрее поправить, чем с 0 писать) | !!!(НЕ ЮЗАЙ ИИ ДЛЯ ОБУЧЕНИЯ/ДЕБАГГИНГА/МЫШЛЕНИЯ)!!!
