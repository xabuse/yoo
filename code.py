...
КОД = {
  (3 часа 5 дней в неделю с утра под брейккорчик/амбиент без уведомлений, в конце коммить че сделал))
  (для обучения юзай документацию) | (ОООЧЕНЬ РЕДКО СТАКОВЕРФЛОВ)
